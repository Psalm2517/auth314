    ...
    <div className="min-h-full">
      ...
      <div className="mx-auto max-w-[680px] px-8 py-16">
        ...
        <p className="mb-10 text-sm text-muted-foreground">
          Last updated July 2026. By using any Auth314 service — including auth314.com,
        ...
        <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            ...
            <p>
              Auth314 provides Pi Network identity verification infrastructure. It allows operators
              (developers, bot owners, community managers) to confirm that an end user holds a genuine
              Pi Network account. Auth314 is operated by Yerette Group and is not affiliated with Pi
          ...
          <section>
            ...
            <p>
              You must be at least 13 years old to use Auth314 services. By using Auth314 you represent
              that you have the legal authority to accept these terms, and if acting on behalf of an
              organization, that you have authority to bind that organization.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              Accessing the dashboard requires a Discord account. You are responsible for keeping your
              API keys confidential. Do not share keys publicly, commit them to public repositories, or
              allow unauthorized parties to use them.
            </p>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1.5">
              <li>Use Auth314 to verify identities without the end user's knowledge or consent.</li>
              <li>Misrepresent the purpose of verification to end users.</li>
          ...
          <section>
            ...
            <p>
              ...
              plans are introduced. Limits are enforced automatically; exceeding them returns an error
              rather than incurring charges. For higher limits, contact{" "}
          ...
          <section>
            ...
            <p>
              The Auth314 Discord bot is provided as a hosted integration tool. By adding it to a server
              you confirm you have the authority to do so and agree to use it in compliance with Discord's
              Terms of Service and Community Guidelines. Auth314 reserves the right to remove the bot
              from servers that violate these terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              informing their end users that verification is powered by Auth314; complying with
              applicable privacy laws in their jurisdiction; not storing or processing the verified
              signal in ways that harm end users; and maintaining their own privacy policy covering their
              use of the verification data delivered to their webhook.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The Auth314 core service is open-source under the MIT License. The Auth314 name, branding,
              and hosted infrastructure are owned by Yerette Group. The open-source license does not
              grant rights to operate a competing hosted service under the Auth314 name.
            </p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-foreground">10. Disclaimer of warranties</h2>
            <p>
              Auth314 is provided "as is" without warranty of any kind, express or implied. Yerette Group
              does not warrant that the service will be uninterrupted, error-free, or that verifications
              will be accepted by Pi Network at all times.
            </p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-foreground">11. Limitation of liability</h2>
            <p>
